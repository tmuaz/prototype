...
public class DiffCommand {
    public static boolean validDiffArgs(String skeletonPath, String submissionPath) throws IOException {
    ...
    public static void printDiff(String skeletonPath, String studentSubmissionPath) throws IOException {
